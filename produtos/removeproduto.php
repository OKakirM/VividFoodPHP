...
<body>
  ...
  <h1 class="fadeInUp">Remover Produtos</h1>
    <form class="formulario-container-pesquisa fadeInUp">
      <input class="search" name="busca" value="<?php if(isset($_GET['busca'])) echo $_GET['busca']; ?>" placeholder="Digite aqui o produto que deseja remover" type="text">
      ...
      <table class="table">
        ...
        ?>
          <tr>
            ...
            <td class="td"><a class="icon" href="remover.php?pedido=<?php echo $dados['pedido'];?>" title="Deletar"><img src="../assets/img/close.svg" alt=""></a></td>
          </tr>
        <?php
            }
          }
