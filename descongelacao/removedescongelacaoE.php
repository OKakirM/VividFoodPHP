...
<body>
  ...
  <div class="menu-table fadeInUp">
    <a class="btn-submit active" href="removedescongelacaoE.php">Entrada</a>
      ...
      <table class="table">
        ...
        ?>
          <tr>
            ...
            <td class="td"><a class="icon" href="removerE.php?id=<?php echo $dados['id'];?>" title="Deletar"><img src="../assets/img/close.svg" alt=""></a></td>
          </tr>
        <?php
            }
          }
