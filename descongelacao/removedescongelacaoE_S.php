...
<body>
  ...
  <div class="menu-table fadeInUp">
    ...
    <a class="btn-submit" href="removedescongelacaoS.php">Saida</a>
    <a class="btn-submit active" href="removedescongelacaoE_S.php">Entrada/Saida</a>
  </div>
    <form class="formulario-container-pesquisa fadeInUp">
      ...
      <table class="table">
        ...
        <?php
            ...
            $sql_code = "SELECT * FROM descongelacaoentrada WHERE id LIKE '%$pesquisa%' 
            OR produto LIKE '%$pesquisa%'
            OR dataEntrada LIKE '%$pesquisa%' 
        ...
        ?>
          <tr>
            ...
            <td class="td"><?php echo $dados['dataEntrada']; ?></td>
            ...
            <td class="td"><a class="icon" href="removerE_S.php?id=<?php echo $dados['id'];?>" title="Deletar"><img src="../assets/img/close.svg" alt=""></a></td>
          </tr>
        <?php
            }
          }
